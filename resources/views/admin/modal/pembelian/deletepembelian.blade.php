...
<script>
    $(document).ready(function() {
        ...
        $('.deleteSwal').click(function() {
            ...
            var idpembelian = current_object.data('idpembelian');
            var nopembelian = current_object.data('nopembelian');
            var action = current_object.data('action');

            Swal.fire({
                title: 'Yakin Untuk Menghapus Data '  + nopembelian + ' ?',
                icon: 'warning',
                iconColor: 'red',
