...
<script>
    $(document).ready(function() {
        ...
        $('.deleteSwal').click(function() {
            ...
            var idsupplier = current_object.data('idsupplier');
            var namasupplier = current_object.data('namasupplier');
            var action = current_object.data('action');

            Swal.fire({
                title: 'Yakin Untuk Menghapus Data ' + namasupplier + ' ?',
                icon: 'warning',
                iconColor: 'red',
