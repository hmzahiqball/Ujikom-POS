...
<script src="{{ URL::asset('js/buttons.dataTables.js') }}"></script>
    ...
    layout: {
        topStart: {
            buttons: ['copy', 'excel', 'csv', {
                extend: 'pdf',
                title: 'Judul PDF Anda', // Tentukan judul PDF di sini
                filename: function() {
                        // Membuat nama file sesuai dengan judul
                        return 'Nama_File_' + moment().format('MMM Do YYYY');
